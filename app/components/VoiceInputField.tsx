...
/**
 * Text input field with integrated voice input capability
      ...
      <div className="relative flex items-center">
        ...
        {showVoiceButton && (
          <button
            ...
            disabled={disabled}
            className="absolute right-2 rounded-full p-2 text-gray-500 hover:bg-gray-100 hover:text-medical-600 disabled:cursor-not-allowed disabled:opacity-50 dark:text-gray-400 dark:hover:bg-gray-700"
