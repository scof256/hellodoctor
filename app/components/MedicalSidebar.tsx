...
interface MedicalSidebarProps {
  ...
  showDoctorHandover?: boolean;
}

const MedicalSidebar: React.FC<MedicalSidebarProps> = ({ data, thought, onTopicTrigger, showDoctorHandover = true }) => {
    ...
    <div className="h-full flex flex-col bg-white border-l border-slate-200">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 bg-slate-50/50">
        {activeTab === 'intake' ? (
          ...
          <HandoverTab data={data} showUCG={showUCG} setShowUCG={setShowUCG} showFullAnalysis={showFullAnalysis} setShowFullAnalysis={setShowFullAnalysis} />
        ) : null}
      </div>
    </div>
  );
...
interface HandoverTabProps {
  data: MedicalData;
  showUCG: boolean;
  setShowUCG: (show: boolean) => void;
  showFullAnalysis: boolean;
  setShowFullAnalysis: (show: boolean) => void;
}

const HandoverTab: React.FC<HandoverTabProps> = ({ data, showUCG, setShowUCG, showFullAnalysis, setShowFullAnalysis }) => (
